...
export const assets = {
  ...
  portfolioTrend: async (): Promise<{ assets: { id: string; name: string; type: string; group_id: string | null; investment_category: string | null }[]; trend: Record<string, unknown>[]; total: number }> => {
